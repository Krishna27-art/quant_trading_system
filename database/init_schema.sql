...
CREATE OR REPLACE FUNCTION record_merger(
    ...
    p_merger_date DATE,
    p_swap_ratio DOUBLE PRECISION DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS raw_options_chain (
    ...
    rho DOUBLE PRECISION,  -- Option Rho
...
CREATE TABLE IF NOT EXISTS raw_fii_dii_flows (
    ingest_id VARCHAR,
    date DATE NOT NULL,
    fii_buy_value_cr DOUBLE PRECISION,
    fii_sell_value_cr DOUBLE PRECISION,
    fii_buy_contracts BIGINT,
    fii_sell_contracts BIGINT,
    fii_net_value_cr DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS corporate_action_events (
    ...
    dividend_percentage DOUBLE PRECISION,
    description TEXT,
    effective_from DATE NOT NULL,
    effective_to DATE,
    is_current BOOLEAN DEFAULT TRUE,
...
CREATE TABLE IF NOT EXISTS earnings_events (
    ...
    yoy_profit_growth DOUBLE PRECISION,
    source VARCHAR DEFAULT 'NSE',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS equity_features (
    ...
    -- Volume Features
    volume_ma_20d DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS promoter_holding_pit (
    ...
    symbol VARCHAR NOT NULL,
    promoter_name VARCHAR,
    holding_percentage DOUBLE PRECISION NOT NULL,
    shares_held BIGINT,
    total_shares BIGINT,
    announcement_date TIMESTAMP NOT NULL,
    effective_date TIMESTAMP NOT NULL,
    ...
    available_at TIMESTAMP NOT NULL,
    is_revised BOOLEAN DEFAULT FALSE,
    previous_holding_percentage DOUBLE PRECISION,
    revision_reason VARCHAR,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS corporate_actions_pit (
    ...
    buyback_price DOUBLE PRECISION,
