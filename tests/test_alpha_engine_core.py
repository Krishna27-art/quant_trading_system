"""
Core Unit Tests for Alpha Engine

Tests individual alpha engine modules without external dependencies.
Tests only the core modules that don't depend on regime or other external systems.
"""
...
class TestAlphaRanker:
    ...
    def test_rank_stocks(self, sample_category_scores):
        ...
        # Only stocks with EXCELLENT grade or higher pass by default
        assert ranking.total_passed >= 2
